  ...
  return (
    <main className="noise relative min-h-screen">
      <div className="mx-auto max-w-6xl px-4 py-6 sm:px-6 sm:py-10 space-y-6">
        ...
        <Reveal delay={0.08}><HotPicks picks={data.picks} /></Reveal>
        <Reveal delay={0.16}><Slate games={data.slate} /></Reveal>
        <Reveal delay={0.24}><Injuries injuries={data.injuries} /></Reveal>
